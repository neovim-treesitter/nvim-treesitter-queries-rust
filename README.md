...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rust/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rust/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rust**, part of the
...
- [ ] Changes are scoped to `rust` — do not include files for other languages
